    ...
    (e.prototype = {
        init: function () {
            var b = this,
                ...
                d = jQuery("<div/>", { class: "tooltip", text: "Min " + this.options.minChars + " chars" });
        ...
        check: function (a) {
            ...
            (upperCase = new RegExp("[A-Z]")),
                ...
                (c = a.length >= this.options.minChars ? 1 : -1),
                (d = a.match(upperCase) ? 1 : 0),
                (e = a.match(e) ? 1 : 0),
                (f = a.match(specialchars) ? 1 : 0),
                (b = c + d + e + f),
                (securePercentage = (b / 4) * 100),
        ...
        addStatus: function (b) {
            var c = "",
                ...
                f = e.find(".tooltip");
            e.attr("class", "passtrengthMeter"),
                b >= 25 && (e.attr("class", "passtrengthMeter"), (c = "weak"), (d = this.options.textWeak)),
                b >= 50 && (e.attr("class", "passtrengthMeter"), (c = "medium"), (d = this.options.textMedium)),
                b >= 75 && (e.attr("class", "passtrengthMeter"), (c = "strong"), (d = this.options.textStrong)),
                b >= 100 && (e.attr("class", "passtrengthMeter"), (c = "very-strong"), (d = this.options.textVeryStrong)),
                e.addClass(c),
                this.options.tooltip && f.text(d);
        },
        togglePassword: function () {
            
            var b = jQuery("<span/>", { class: "showPassword", html: "<img src=" + this.options.eyeImg + " />" }),
                d = jQuery("<input/>", { type: "text" }),
                e = this;
            b.appendTo(a(this.element).closest(".passtrengthMeter")),
                d.appendTo(a(this.element).closest(".passtrengthMeter")).hide(),
                a(this.element).bind("keyup keydown", function () {
                ...
                a(c).on("click", ".showPassword", function () {
                    ...
                    if(a(e.element).attr('type') == 'text'){
                        a(e.element).attr('type','password');
                    } else {
                        a(e.element).attr('type','text');
                    }
                });
        },
    }),
